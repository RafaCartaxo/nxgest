...
export interface IEmpresaRepository {
  ...
  create(input: { nome: string; documento?: string | null; nomeFantasia?: string | null; ativa?: boolean; adminNome: string; adminEmail: string; adminTelefone?: string | null; origem?: string | null; emailContato?: string | null; telefoneContato?: string | null }): Promise<{ empresa: EmpresaComStats; admin: { id: string; nome: string; email: string } }>
