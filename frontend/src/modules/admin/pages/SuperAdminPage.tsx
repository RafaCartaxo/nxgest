...
export function SuperAdminPage() {
  ...
  async function handleCreate(data: { nome: string; documento?: string; nomeFantasia?: string; ativa: boolean; adminNome: string; adminEmail: string }) {
    await feedback.run({
  ...
  function handleUpdateEmpresa(data: { nome: string; documento?: string; nomeFantasia?: string; ativa: boolean; adminNome: string; adminEmail: string }) {
