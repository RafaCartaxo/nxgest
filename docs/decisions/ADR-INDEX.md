...
|---|---|---|---|---|
| [ADR-001](../foundation/ADR-001-Arquitetura.md) | Arquitetura Base do Projeto | Aprovado | 27/06/2026 |
...
Novos ADRs devem seguir o template disponível em [templates/ADR.template.md](../templates/ADR.template.md).

Os ADRs são armazenados no diretório [foundation/](../foundation/).
