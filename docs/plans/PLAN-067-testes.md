...
| Integração API | smoke 274/274 ✅ | manter + CI |
...
- `npm test` verde (unit + UI) · `test:coverage` ≥ meta · **CI verde no push** · smoke 274/274 mantido · `audit:ui/styles/modules` e `docs:audit` ✅ · nenhuma regressão.
