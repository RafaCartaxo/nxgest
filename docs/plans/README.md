...
| [PLAN-084-organizacao-repositorio.md](PLAN-084-organizacao-repositorio.md) | **Organização do repositório** — classificação por responsabilidade, fronteira Git/Docker, sync factual de docs/índices/status, convenção de nomes `nxgest`, referências órfãs e integridade CI/CD (trilha separada) | 📝 Planejado (19/08) |
