...
| [Lovable-Perfil-Conta-NXGest.md](Lovable-Perfil-Conta-NXGest.md) | Briefing Lovable: **Perfil & Conta (PLAN-075)** — Meus dados · Operador form/detail/lista · Ativação · Verificação de e-mail · Conta suspensa · Login | ⏳ Aguardando identidade (Lovable) |
