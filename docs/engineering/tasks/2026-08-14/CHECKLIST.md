...
- [x] Commitar port Stitch + ajustes — commit `02f4e7a` (15 arquivos: Perfil, OperadorForm/List/Detail, Ativar, Suspensa, i18n, docs)
- [x] Parar a instância smoke (porta 3002) — parada (porta livre, verificado 15/08)
